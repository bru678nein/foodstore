...
import { FormularioRegistro } from "@/funcionalidades/sesion/FormularioRegistro"

export function PaginaRegistro() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-crema-200 via-crema-100 to-primario-50 px-4 py-10">
